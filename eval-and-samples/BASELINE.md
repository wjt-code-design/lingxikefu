...
- **2026-08-28 二次冻结（达标，权威口径）**：CI full_eval run **33176656355**（commit 3241013，全量 100 题，7 job 全绿）：**qa 74/82 = 90.2% / refuse 7/7 = 100% / citation 208/209 = 99.5%**，全部达标。此三项为**新下限**，后续任何改动跌破即 CI 红。
  - 首跑 run 33170670510（523160b）refuse 85.7% 破线（Q042 场景归类缺陷），S4 修复后复核通过（归因清单 §六）。
